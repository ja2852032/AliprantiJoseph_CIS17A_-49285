 ...
 * Created on October 25th, 2020, 6:05 PM
 * Purpose:  Create a game of Battleship between the user and the computer
 * 
 * Version 5 (Final Version): Implement required structures, arrays
 *              files, enumerators, etc. to complete checklist
 */
...
void play(char [][COLS],char [][COLS],char [][COLS],char [][COLS],topRow *,const int); //Function stepping through game
...
int main(int argc, char** argv) {
    ...
    play(usrGrid,tarGrid,comGrid,ctGrid,topArr,MAX);
...
void play(char uGrid[][COLS],char tGrid[][COLS],char cGrid[][COLS],char ctGrid[][COLS],topRow *topArr,const int rows){
    int res;
    int i=0;
