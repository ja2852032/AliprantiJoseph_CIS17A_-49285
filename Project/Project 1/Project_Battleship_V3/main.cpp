 ...
 * Created on October 17th, 2020, 3:05 PM
 * Purpose:  Create a game of Battleship between the user and the computer
 * 
 * Version 3: Create an extra grid to keep track of the computer's 
 *            guesses (ctGrid), and create a function that flags whether the user
 *            or computer has repeated a guess, making them pick an available
 *            coordinate.  Also split the user and computer guessing into
 *            different functions to clean up the play function for a better
 *            loop and visual.
 */
...
void play(char [][COLS],char [][COLS],char [][COLS],char [][COLS],const int); //Function stepping through game
...
int main(int argc, char** argv) {
    ...
    play(usrGrid,tarGrid,comGrid,ctGrid,MAX);
...
void play(char uGrid[][COLS],char tGrid[][COLS],char cGrid[][COLS],char ctGrid[][COLS],const int rows){
    int r, //Row input
        c, //Column input
...
void uTurn(char tGrid[][COLS],char cGrid[][COLS]){
    ...
    cout<<"Enter the x-coordinate (Letter A through J, not case sensitive): ";
    cin>>cChar;
