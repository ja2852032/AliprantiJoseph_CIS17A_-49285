 ...
 * Created on December 12th, 2020, 2:25 PM
 * Purpose:  Create a game of Battleship between the user and the computer
 * 
 * Version 2:  Turn previous TopRow structure into a class, examine the
 *             problem with the sunk() function and why it shows "Ship
 *             has sunk" when user or computer hits a certain side of a
 *             ship, but hasn't destroyed it completely.
 */
